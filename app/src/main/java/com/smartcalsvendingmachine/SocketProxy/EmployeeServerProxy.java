...
public class EmployeeServerProxy implements EmployeeServer {
    private Socket socket;
    private InputStream in;
    private OutputStream out;

    public String connect(String serverIP, int employee, String password) throws Exception {
        socket = new Socket(serverIP, Const.SERVER_PORT);
        in = socket.getInputStream();
        out = socket.getOutputStream();

        return authenticate(employee, password);
    }
