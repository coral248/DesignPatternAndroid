...
//content provider for the vending machine SQLite database
//providing an interface for all apps to access this database
...
public class VendingMachineContentProvider extends ContentProvider {
    ...
    public Uri insert(Uri uri, ContentValues values) {
        ...
        if (rowID > 0) {
            ...
            //notify change when database is modified.
